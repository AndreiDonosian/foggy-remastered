...
var FrenifyTechWave = {
            ...
            .on("click", function () {
                ...
                if (
                    ...
                    setTimeout(function () {
                        ...
                        parent
                            .find(".models__results")
                            .removeClass("loading");
                        parent
                            .find(".tab__item.active")
                            .removeClass("active");
    ...
    contactForm: function () {
        $("#send_message").on("click", function () {
            ...
            var success = $(".fn_contact_form .returnmessage").data(
                "success"
            );
            ...
            if (name === "" || email === "" || message === "") {
                ...
                $.post(
                    ...
                    function (data) {
                        ...
                        if (
                            $(
                                ".fn_contact_form .returnmessage span.contact_error"
                            ).length
                        ) {
    ...
    aiChatBot__chat: function () {
        if (
            $("#fn__chat_textarea").length &&
            !$(".techwave_fn_intro").length
        ) {
                ...
                if (text === "" || button.hasClass("disabled")) {
                    ...
                    if (activeChatItem.attr("id") === "chat0") {
                        ...
                        var newChatToRightPanel =
                            ...
                            id +
                            '"><span class="text">New Chat</span><input type="text" value="New Chat"><span class="options"><button class="trigger"><span></span></button><span class="options__popup"><span class="options__list"><button class="edit">Edit</button><button class="delete">Delete</button></span></span></span><span class="save_options"><button class="save"><img src="build/svg/check.svg" alt="" class="fn__svg"></button><button class="cancel"><img src="build/svg/close.svg" alt="" class="fn__svg"></button></span></div></li>';
            ...
            if (TechwaveUserQuestion.slice(0, 1) === "/") {
                ...
                if (allCommands.hasOwnProperty(question)) {
                    ...
                    if (type === "text") {
                        ...
                        if (countjoke > 1) {
                            var shuffled =
                                FrenifyTechWave.shuffleArray(allJokes);
                            var selected = shuffled.slice(0, countjoke);
                            botText = "<ul>";
                            if (
                                countjoke >= 1 &&
                                countjoke <= allJokes.length
                            ) {
        ...
        $(".fn__chat_link")
            ...
            .on("click", function () {
                ...
                if (!element.hasClass("active")) {
                    ...
                    $(".fn__chatbot .chat__item.active").removeClass(
                        "active"
                    );
                    element.addClass("active");
                    $(element.attr("href")).addClass("active");
        ...
        $(".techwave_fn_pricing .toggle_in a")
            ...
            .on("click", function () {
                ...
                if (!element.hasClass("active")) {
                    ...
                    var offset =
                        element.offset().left - parent.offset().left;
                    pricing
                        .find(".pricing__tab.active")
                        .removeClass("active");
                    $(element.attr("href")).addClass("active");
                    element.siblings().removeClass("active");
                    element.addClass("active");
    ...
    feedFilters: function () {
        ...
        $(
            '.techwave_fn_feed .filter__select input[type="checkbox"]'
        ).change(function () {
            var element = $(this);
        ...
        $(".fn__selectable_item")
            ...
            .on("click", function () {
                ...
                page.find(".fn__selection_box .count").text(
                    TechwaveSelectedCount
                );
                return false;
            });
        ...
        $(".techwave_fn_feed .filter__sorting a").on("click", function () {
            var element = $(this);
            if (
                !element.hasClass("enabled") &&
                !TechwaveFeedFilterLoading
            ) {
                TechwaveFeedFilterLoading = true;
                element
                    .siblings()
    ...
    navBarItems: function () {
        ...
        userItem.find(".user_opener").on("click", function (e) {
            ...
            // close lightboxes
            $(".bar__item_language,.bar__item_notification").removeClass(
                "opened"
            );
            return false;
        });
        ...
        // light and dark mode
        var darklightSwitcher = $(
            ".fn__nav_bar .bar__item_skin .item_opener"
        );
        ...
        languageItem.find(".item_opener").on("click", function (e) {
            ...
            // close lightboxes
            $(".bar__item_user,.bar__item_notification").removeClass(
                "opened"
            );
            return false;
        });
...
(function ($) {
    ...
    // activation
    var activePath = window.location.href;
    $('.leftpanel_content a.menu__item').removeClass('active');
