<x-layouts.guest>
    <x-slot name="title">Welcome page | Avks.cloud</x-slot>
    <x-slot name="meta">
    ...
    <div class="techwave_fn_privacy_page">
        ...
        <div class="techwave_fn_pagetitle">
            <h2 class="title">Welcome to Avks.cloud</h2>
        ...
        <div class="privacypage">
            <div class="container small">
                ...
                <p>Welcome to our community, where your privacy and data security are our top priorities. Whether you are a student, a business professional, or anyone with a creative idea, we are here to support you. Our mission is to provide a secure space for storing and managing your digital files, ensuring that your valuable information remains protected. Join us and experience peace of mind, knowing your data is safe with us.</p>
                <hr>
            ...
            <ul>
                ...
                <p><b>First-Time User Discount: </b> Enjoy reduced rates on your first storage plan with us.</p></p>
                <p><b>Referral Program:</b> Refer a friend and both of you will receive a special bonus upon their plan activation.</p>
                <p> reffer botton or link for reference </p>
                <hr>
                ...
                <p>Join the thousands of satisfied customers who have secured their data with AVKS.cloud. Start your journey today and take the first step towards a secure and reliable data storage solution.</p>

                <p> Vew price page botton </p>
                <hr>
