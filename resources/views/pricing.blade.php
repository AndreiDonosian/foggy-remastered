    ...
    <div class="techwave_fn_pricing_page">
        ...
        <div class="techwave_fn_title_holder">
            <div class="container">
                ...
                <p class="desc fn__animated_text">Start small and free, upgrade as you go. Take control of everything.
                </p>
            </div>
        </div>
                            ...
                            <div class="pricing__item">
                                <div class="pricing__item_holder">
                                    <div class="pricing__item__header">
                                        ...
                                        <p class="purchase">
                                            <a href="javascript:void(0);" class="techwave_fn_button"><span>Buy Personal</span></a>
                                        </p>
                                    </div>
                            ...
                            <div class="pricing__item">
                                <div class="pricing__item_holder">
                                    ...
                                    <div class="pricing__item__header">
                                        ...
                                        <p class="purchase">
                                            <a href="javascript:void(0);" class="techwave_fn_button"><span>Buy Premium</span></a>
                                        </p>
                                    </div>
                                    <div class="pricing__item__heading">
                                        <h2 class="title">Main Features</h2>
                            ...
                            <div class="pricing__item">
                                <div class="pricing__item_holder">
                                    <div class="pricing__item__header">
                                        ...
                                        <p class="purchase">
                                            <a href="javascript:void(0);" class="techwave_fn_button"><span>Buy
                                                    Enterprice</span></a>
                                        </p>
                                    </div>
                                    <div class="pricing__item__heading">
                                    ...
                                    <div class="pricing__item_footer">
                                        <a href="javascript:void(0);" class="techwave_fn_button"><span>Buy Enterpice</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- !First Plan -->
                        ...
                        <div class="pricing__content">
                            ...
                            <div class="pricing__footer">
                                <div class="item_row">
                                    ...
                                    <div class="item_col">
                                        <a href="javascript:void(0);" class="techwave_fn_button"><span>Buy Enterprice</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- !table's footer -->
        ...
        <div class="techwave_fn_title_holder">
            <div class="container">
                ...
                <p class="desc fn__animated_text">Many support queries and technical questions will already be answered
                </p>
            </div>
        </div>
            ...
            <div class="techwave_fn_accordion" data-type="accordion"> <!-- data-type values: accordion, toggle -->
                ...
                <div class="acc__item">
                    ...
                    <div class="acc__content">
                        <p>TECH-AI is an AI-powered content production suite that empowers creators with a powerful,
                            customisable, and user-friendly platform for bringing their ideas to life.</p>
                        <p>With a focus on granular control at every step of content creation, we put creators at the
                            centre of the creative process by offering granular control at every stage of generation,
                            ensuring that AI enhances, rather than replaces, human creative potential.</p>
                        <p>Our custom back-end delivers advancements in model fine tuning, prompt adherence, training
                            and inference speed, and multi-image prompting functionality. We also address common issues
                            around image degradation and have implemented a custom upscaling, with much more on the way!
                        </p>
                    </div>
                </div>
                <!-- !#1 accordion item -->
